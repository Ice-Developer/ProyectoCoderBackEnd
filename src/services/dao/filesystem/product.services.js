...
export class ProductManager {
    ...
    createProduct = async ({title, description, price, thumbnail, code, stock, available}) => {
        let newProduct = new Product(title, description, price, thumbnail, code, stock, available);
        try{
